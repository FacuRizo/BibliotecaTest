...
class Biblioteca{
    constructor(librosDisponibles =[],librosPrestados=[],inventarioLibros=[]){
...
/*
    ...
    moverLibro(libro,origen,destino){
        ...
        if (destino === this.librosPrestados) { // verificamos q lista es para agregar correctamente
            this.agregarLibroPrestado(libro);
